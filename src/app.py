...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training, stroke technique, and friendly meets",
        "schedule": "Tuesdays, Wednesdays, 5:00 PM - 6:30 PM",
        "max_participants": 20,
    ...
    "Science Club": {
        "description": "Conduct experiments, explore scientific concepts, and present findings",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["mia@mergington.edu", "ryan@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Prepare for math competitions and solve challenging problems together",
